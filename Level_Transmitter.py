...
class AR6451():
    def __init__(self, client, slaveAddress = 1, m = 102.04081632653, b = 0):
...
# level_sensor = AR6451(slaveAddress = 3)
# level_sensor.readRegister(address= 0)
# level_sensor.Pressure()
